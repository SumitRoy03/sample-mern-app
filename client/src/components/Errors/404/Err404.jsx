    ...
    <>
      ...
      <div className="error">
        ...
        <div className="error__description">
          I guess the user has left this world.
          <br />
          Try another planet...
        </div>
        <button className="error__button" onClick={handleClickLogin}>LOGIN</button>
        <button className="error__button error__button--active" onClick={handleClickHome}>Home</button>
      </div>
